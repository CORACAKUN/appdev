...
export default function RegisterPage() {
  ...
  return (
    <div className="p-6 w-[40%] mx-auto bg-white/25 backdrop-blur-md rounded-xl shadow-xl">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div>
          <input
            ...
            className="w-full text-white px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
          />
        ...
        <div>
          <input
            ...
            readOnly
            placeholder="Pin Point Address Below"
            className="w-full text-white px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
          />
